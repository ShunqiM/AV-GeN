...
_C.RL.PPO.ssound = False
_C.RL.PPO.aunet_lr = 1e-2
_C.RL.PPO.au_width = 10
_C.RL.PPO.batch = 32
_C.RL.PPO.ss_coef = 0.1
# -----------------------------------------------------------------------------
# TASK CONFIG
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# ALTERNATIVE_AUDIO_SENSOR
# -----------------------------------------------------------------------------
_TC.TASK.SWITCH_AUDIO_SENSOR = CN()
_TC.TASK.SWITCH_AUDIO_SENSOR.TYPE = "SwitchAudioSensor"
# -----------------------------------------------------------------------------
# ALTERNATIVE SPECTROGRAM_SENSOR
# -----------------------------------------------------------------------------
_TC.TASK.SWITCH_SPECTROGRAM_SENSOR = CN()
_TC.TASK.SWITCH_SPECTROGRAM_SENSOR.TYPE = "SwitchSpectrogramSensor"
# Sound Source Sensor
# -----------------------------------------------------------------------------
_TC.TASK.SOUND_SOURCE_SENSOR = CN()
_TC.TASK.SOUND_SOURCE_SENSOR.TYPE = "SoundSourceSensor"
# -----------------------------------------------------------------------------
# soundspaces
# -----------------------------------------------------------------------------
...
_TC.SIMULATOR.SCENE_OBSERVATION_DIR = 'data/semantic_observations'
# _TC.SIMULATOR.SCENE_OBSERVATION_DIR = 'data/scene_observations'
_TC.SIMULATOR.EVAL_RUN = False
_TC.SIMULATOR.MIX = False
...
_TC.SIMULATOR.AUDIO.NUM_ALTERNATIVES = 1
...
def get_config(
    ...
    if "SIMULATOR" in config.TASK_CONFIG:
        eval = config.TASK_CONFIG.SIMULATOR.EVAL_RUN
        mix = config.TASK_CONFIG.SIMULATOR.MIX
    else:
        eval = True
        mix = False
    ...
    config.TASK_CONFIG.SIMULATOR.EVAL_RUN = eval
    config.TASK_CONFIG.SIMULATOR.MIX = mix
