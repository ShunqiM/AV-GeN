...
from ss_baselines.av_exp.ppo.policy import AudioNavBaselinePolicy
from ss_baselines.av_exp.ppo.ppo import PPO

from ss_baselines.common.utils import convert_semantics_to_rgb
import pandas as pd
import pickle
import errno
...
class PPOTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config, observation_space=None) -> None:
        ...
        self.actor_critic = AudioNavBaselinePolicy(
            ...
            ssound = ppo_cfg.ssound,
            au_width = ppo_cfg.au_width,
            batch = ppo_cfg.batch
        )
    ...
    def train(self) -> None:
        ...
        if 'SEMANTIC_SENSOR' in self.config.TASK_CONFIG.SIMULATOR.AGENT_0.SENSORS:
            self.envs.observation_spaces[0].spaces['semantic'] = np.zeros((128, 128, 4))
        ...
        with TensorboardWriter(
            ...
            for update in range(self.config.NUM_UPDATES):
                ...
                if update % 20 == 0:
                    ...
                    writer.add_scalar('Policy/SS_Loss', ss_loss, count_steps)
    ...
    def _eval_checkpoint(
        ...
        pretrained_dict = {k: v for k, v in ckpt_dict["state_dict"].items() if k in self.agent.state_dict()}
        

        self.agent.load_state_dict(pretrained_dict)
